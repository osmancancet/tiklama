...
const simulations: Record<string, React.ComponentType> = {
    ...
    "sahte-teknik-destek": dynamic(() => import("@/simulations/Sim26")),
    "sim-swap-saldirisi": dynamic(() => import("@/simulations/Sim27")),
    "sahte-edevlet": dynamic(() => import("@/simulations/Sim28")),
    "sahte-banka-uygulamasi": dynamic(() => import("@/simulations/Sim29")),
    "qr-kod-tuzagi": dynamic(() => import("@/simulations/Sim30")),
};
