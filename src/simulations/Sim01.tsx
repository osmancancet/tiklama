...
export default function Sim01() {
    ...
    return (
        <div className="relative min-h-[480px] sm:min-h-[520px] w-full max-w-sm sm:max-w-md mx-auto bg-black rounded-[2rem] sm:rounded-[3rem] border-4 sm:border-[8px] border-gray-900 overflow-hidden shadow-2xl font-sans text-white select-none">
            ...
            {/* Status Bar */}
            <div className="absolute top-2 w-full px-5 flex justify-between text-[11px] font-medium z-40 text-white/80">
                <span>09:41</span>
            ...
            <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        {phase === "active" && (
                            <div className="grid grid-cols-3 gap-4 mb-8">
                                <div className="flex flex-col items-center gap-1 opacity-50"><div className="w-14 h-14 rounded-full bg-white/10 flex items-center justify-center"><Mic /></div><span className="text-[11px]">Sessiz</span></div>
                                <button onClick={() => setPhase("keypad")} className="flex flex-col items-center gap-1 hover:opacity-80 transition-opacity">
                                    ...
                                    <span className="text-[11px]">Klavye</span>
                                </button>
                                <div className="flex flex-col items-center gap-1 opacity-50"><div className="w-14 h-14 rounded-full bg-white/10 flex items-center justify-center"><Volume2 /></div><span className="text-[11px]">Hoparlör</span></div>
                            </div>
                        )}
                ...
                {phase === "result" && (
                    <motion.div
                        ...
                        className="absolute inset-0 bg-black/90 backdrop-blur-sm z-30 p-3 sm:p-6 overflow-y-auto"
                    >
                        <SimulationResult
                            isCorrect={correct}
