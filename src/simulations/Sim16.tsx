                ...
                {phase === "sms" && (
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="bg-gray-100 rounded-xl p-4 mb-4 relative shadow-lg border-l-4 border-blue-500 cursor-pointer hover:bg-gray-50 transition-colors"
                            onClick={() => setPhase("tracking")}
                        >
                            <div className="absolute top-0 left-1/2 -translate-x-1/2 -mt-2 bg-gray-200 text-[11px] px-2 rounded-full text-gray-700 shadow-sm">
                                Şimdi 🔔
                            </div>
                            <div className="flex items-start gap-3">
                                <div className="bg-blue-100 w-10 h-10 rounded-full flex items-center justify-center text-blue-600 font-bold animate-pulse">
                                    📦
                                </div>
                                <div>
                                    <div className="font-bold text-gray-800 mb-1 flex justify-between">
                                        MNG KARGO
                                        <span className="text-[11px] text-gray-400 font-normal">Mesajlar</span>
                                    </div>
                                    <p className="text-gray-700 text-sm leading-snug">
                                        Sayın Müşterimiz, kargonuz adresinize teslim edilememiştir. Lütfen 24 TL gümrük ücretini ödemek için tıklayınız...
                                        <span className="text-blue-500 block text-xs mt-1 font-semibold">Tıklayın ve Takip Edin &gt;</span>
                                    </p>
                                </div>
                            </div>
                        </motion.div>
                        <div className="text-center text-xs text-gray-400 mt-8 animate-bounce">
                            👆 Mesaja dokunun
                        </div>
                    </motion.div>
                )}
                        ...
                        <div className="bg-white w-full rounded-t-xl sm:rounded-xl p-6 shadow-2xl animate-slide-up">
                            ...
                            <div className="flex gap-2">
                                <button
                                    ...
                                    className="flex-1 bg-green-600 text-white py-3 rounded font-bold text-sm"
                                >
                                    Onayla
                                </button>
                                <button
                                    onClick={() => { setCorrect(true); setPhase("result"); }}
                                    className="flex-1 bg-red-500 text-white py-3 rounded font-bold text-sm"
                                >
